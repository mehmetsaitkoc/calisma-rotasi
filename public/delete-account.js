...
function failure(error){status.textContent=error.name==='TimeoutError'?'İstek gecikti. Silme durumunu yeniden giriş yaparak kontrol et; sonuç doğrulanmadan yeni işlem başlatma.':error.message||'İşlem tamamlanamadı.';}
