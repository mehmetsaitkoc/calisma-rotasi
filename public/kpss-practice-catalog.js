...
T('k-tr-1-practice-01','k-tr','Sözcükte anlam','KPSS Sözcükte Anlam · Hızlı Pratik',[
 Q('tr1q1','k-tr-1','Eleştirmen, yazarın son romanında dili “arıtmayı” seçtiğini söylüyor. Bu cümlede “arıtmak” sözcüğü hangi anlamda kullanılmıştır?',['Dili yabancı ve gereksiz ögelerden temizlemek','Anlatımı uzatmak','Kişileri çoğaltmak','Olayları hızlandırmak','Konuyu değiştirmek'],0,'Bağlamda arıtmak, dili gereksiz/yabancı ögelerden temizlemek anlamındadır.'),
 Q('tr1q2','“Bu küçük ayrıntı, araştırmanın yönünü değiştiren bir ipucu oldu.” cümlesinde “ipucu” sözcüğü aşağıdakilerden hangisine en yakındır?',['Kesin sonuç','Yol gösteren belirti','Gizli amaç','Yanlış bilgi','Önemsiz ayrıntı'],1,'İpucu, sonuca ulaşmada yol gösteren belirti anlamındadır.'),
 Q('tr1q3','“Toplantıda söylenenleri süzgeçten geçirerek aktardı.” cümlesindeki altı çizili sözün anlamı hangisidir?',['Olduğu gibi tekrarlamak','Seçip değerlendirerek iletmek','Abartarak anlatmak','Unutarak eksiltmek','Gizlice kaydetmek'],1,'Süzgeçten geçirmek, bilgiyi seçip değerlendirerek aktarmayı anlatır.'),
 Q('tr1q4','“Onun bu konudaki tavrı zamanla yumuşadı.” cümlesinde “yumuşamak” sözcüğü hangi anlamda kullanılmıştır?',['Sesini azaltmak','Fiziksel olarak esnemek','Daha ılımlı hâle gelmek','Kararsız kalmak','Gücünü kaybetmek'],2,'Tavrın yumuşaması daha ılımlı hâle gelmek demektir.')
]),
T('k-tr-2-practice-01','k-tr','Cümlede anlam','KPSS Cümlede Anlam · Hızlı Pratik',[
 Q('tr2q1','“Düzenli tekrar yaparsan bilgilerin daha kalıcı olur.” cümlesinde hangi anlam ilişkisi vardır?',['Neden-sonuç','Koşul-sonuç','Amaç-sonuç','Karşılaştırma','Varsayım'],1,'Kalıcı olma, düzenli tekrar yapma koşuluna bağlanmıştır.'),
 Q('tr2q2','“Yağmur başladığı için maç ertelendi.” cümlesinde hangi anlam ilişkisi vardır?',['Amaç-sonuç','Koşul-sonuç','Neden-sonuç','Karşıtlık','Olasılık'],2,'Maçın ertelenmesinin nedeni yağmurun başlamasıdır.'),
 Q('tr2q3','“Bu kitabı, konuya farklı bir açıdan bakabilmek için okudum.” cümlesinde hangi anlam vardır?',['Amaç-sonuç','Neden-sonuç','Koşul','Yakınma','Öneri'],0,'Okuma eyleminin amacı farklı açıdan bakabilmektir.'),
 Q('tr2q4','“Yeni yöntem, eskisine göre daha az zaman alıyor.” cümlesinde hangisi vardır?',['Tanım','Karşılaştırma','Öznel yargı','Koşul','Kesinlik'],1,'Yeni ve eski yöntem süre bakımından karşılaştırılmıştır.')
]),
T('k-tr-3-practice-01','k-tr','Paragrafta anlam','KPSS Paragrafta Anlam · Hızlı Pratik',[
 Q('tr3q1','Bir şehrin belleği yalnız anıtlarda saklı değildir. Mahalle arasındaki fırın, yıllardır aynı köşede duran ağaç ve insanların birbirine sesleniş biçimi de bu belleğin parçalarıdır. Bu parçanın ana düşüncesi hangisidir?',['Şehirler sürekli değişmelidir.','Kent belleği gündelik yaşamın küçük unsurlarında da yaşar.','Anıtlar şehirler için gereksizdir.','Mahalle kültürü yalnız eski şehirlerde görülür.','Ağaçlar tarihî yapılardan daha değerlidir.'],1,'Parça kent belleğinin gündelik ayrıntılarda da sürdüğünü vurgular.'),
 Q('tr3q2','Bir araştırmacı için iyi soru, cevabı hemen bulunan soru değildir. Bazen doğru soru yeni veriler toplamayı, eski varsayımları yeniden sınamayı gerektirir. Parçada asıl anlatılmak istenen nedir?',['Araştırma yalnız veri toplamaktır.','İyi sorular düşünmeyi ve yeniden sınamayı tetikler.','Eski bilgiler her zaman yanlıştır.','Hızlı cevap bilimsel başarının ölçüsüdür.','Araştırmacı varsayım kurmamalıdır.'],1,'Vurgu iyi sorunun araştırmayı ve sorgulamayı derinleştirmesidir.'),
 Q('tr3q3','Bir müzik eserini yalnız teknik kusurları arayarak dinlemek, eserin bütününü kaçırmaya yol açabilir. Teknik bilgi önemlidir; ancak ritim, duygu ve yapı birlikte değerlendirilmelidir. Bu parçadan hangisi çıkarılabilir?',['Teknik bilgi gereksizdir.','Müzik yalnız duyguyla anlaşılır.','Değerlendirme hem ayrıntıyı hem bütünü gözetmelidir.','Kusursuz eser yoktur.','Ritim, teknikten her zaman önemlidir.'],2,'Parça ayrıntı ve bütünün birlikte değerlendirilmesini savunur.'),
 Q('tr3q4','Yeni bir alışkanlık edinirken ilk günlerde kusursuz bir program kurmaya çalışmak yerine sürdürülebilir küçük bir adım seçmek çoğu zaman daha etkilidir. Çünkü devamlılık, tek seferlik yoğunluktan daha güçlü bir birikim oluşturur. Parçaya en uygun başlık hangisidir?',['Kusursuz Program','Küçük Adımların Gücü','Yoğun Çalışmanın Önemi','Başarıda Tesadüf','Zaman Kaybı'],1,'Parçanın odağı sürdürülebilir küçük adımların birikimidir.')
]),
T('k-tr-4-practice-01','k-tr','Sözel mantık','KPSS Sözel Mantık · Hızlı Pratik',[
 Q('tr4q1','A, B, C ve D sunumları art arda yapılacaktır. A, B’den önce; C ise D’den sonra yapılacaktır. Buna göre aşağıdaki sıralamalardan hangisi mümkün olabilir?',['B-A-C-D','A-B-D-C','D-C-B-A','C-D-A-B','B-D-A-C'],1,'A B’den önce ve C D’den sonra olmalıdır; A-B-D-C koşulları sağlar.'),
 Q('tr4q2','Bir rafta K, L, M kitapları soldan sağa dizilecektir. K, L’nin solunda; M ise K’nin sağındadır. Aşağıdakilerden hangisi kesinlikle doğrudur?',['M en sağdadır.','L en soldadır.','K, M’nin solundadır.','L, M’nin sağındadır.','M, L’nin solundadır.'],2,'Verilen bilgi doğrudan M’nin K’nin sağında olduğunu söyler; dolayısıyla K M’nin solundadır.'),
 Q('tr4q3','Pazartesi, salı ve çarşamba günlerinden her birinde birer görev yapılacaktır: X, Y, Z. X salı günü değildir; Y, X’ten sonra yapılacaktır. Buna göre X hangi gün olabilir?',['Yalnız pazartesi','Yalnız salı','Yalnız çarşamba','Pazartesi veya salı','Salı veya çarşamba'],0,'Y X’ten sonra olacağı için X çarşamba olamaz; ayrıca salı olmadığı verilmiştir, bu yüzden pazartesidir.'),
 Q('tr4q4','E, F, G ve H kişilerinden iki kişilik ekip kurulacaktır. E seçilirse F seçilemez; G seçilirse H mutlaka seçilir. Aşağıdaki ekiplerden hangisi kurulabilir?',['E-F','G-E','G-F','G-H','E-G'],3,'G seçildiğinde H’nin de seçilmesi zorunludur; G-H mümkündür.')
]),
T('k-tr-5-practice-01','k-tr','Ses bilgisi','KPSS Ses Bilgisi · Hızlı Pratik',[
 Q('tr5q1','Aşağıdaki sözcüklerden hangisinde ünlü düşmesi vardır?',['burnu','kalemi','sokağı','kapısı','oyunu'],0,'Burun + u birleşiminde ikinci hecedeki ünlü düşer: burnu.'),
 Q('tr5q2','Aşağıdaki sözcüklerden hangisinde ünsüz yumuşaması vardır?',['kitabı','sınıfta','ağaçtan','yurtta','seçkin'],0,'Kitap sözcüğündeki p, ünlüyle başlayan ek alınca b’ye dönüşür.'),
 Q('tr5q3','Aşağıdaki sözcüklerden hangisinde ünsüz benzeşmesi görülür?',['kitapçı','odacı','gözlük','evde','yazıcı'],0,'Kitap + cı birleşiminde c, sert ünsüzün etkisiyle ç olur.'),
 Q('tr5q4','“hissetmek” sözcüğünde görülen ses olayı hangisidir?',['Ünlü düşmesi','Ünsüz türemesi','Ünlü daralması','Ünsüz yumuşaması','Ünlü türemesi'],1,'His + etmek birleşiminde s ünsüzü türemiştir.')
]),
T('k-tr-6-practice-01','k-tr','Yazım kuralları','KPSS Yazım Kuralları · Hızlı Pratik',[
 Q('tr6q1','Aşağıdaki cümlelerin hangisinde “de”nin yazımı doğrudur?',['Ben de geleceğim.','Evde ki kitapları topladı.','Oda bizimle gelicek.','Sende biliyorsun.','Bende yarın uğrarım.'],0,'Bağlaç olan de ayrı yazılır: Ben de.'),
 Q('tr6q2','Aşağıdakilerden hangisinin yazımı doğrudur?',['bir çok','herşey','hiçbir','pekçok','bir kaç'],2,'“Hiçbir” birleşik yazılır.'),
 Q('tr6q3','Aşağıdaki cümlelerin hangisinde “ki” doğru yazılmıştır?',['Duydumki gelmeyecekmiş.','Evdeki hesap çarşıya uymadı.','Seninki deil benimki.','Öyleki herkes şaşırdı.','Bilmem ki neden gelmedi mi?'],1,'Sıfat yapan -ki bitişik yazılır: evdeki.'),
 Q('tr6q4','Aşağıdakilerden hangisinde büyük harflerin kullanımı doğrudur?',['Türk Dil Kurumu bugün açıklama yaptı.','ankara Üniversitesi açıldı.','Mayıs Ayında geleceğim.','Doğu anadolu Bölgesi soğuktur.','Pazartesi Günü görüşürüz.'],0,'Kurum adlarının her sözcüğü büyük harfle başlar.')
]),
...
T('k-tr-8-practice-01','k-tr','Sözcük türleri','KPSS Sözcük Türleri · Hızlı Pratik',[
 Q('tr8q1','“Eski ev sessizce boş sokağa bakıyordu.” cümlesinde “eski” sözcüğünün türü nedir?',['İsim','Sıfat','Zarf','Zamir','Bağlaç'],1,'Eski, “ev” ismini nitelediği için sıfattır.'),
 Q('tr8q2','“Çocuk soruyu hızlı çözdü.” cümlesinde “hızlı” sözcüğü hangi türdedir?',['Sıfat','Zarf','İsim','Zamir','Edat'],1,'“Çözdü” fiilinin nasıl yapıldığını belirttiği için zarftır.'),
 Q('tr8q3','“Bazıları toplantıya erken geldi.” cümlesinde “bazıları” hangi türdedir?',['Sıfat','Belgisiz zamir','İşaret zamiri','Zarf','Bağlaç'],1,'İsmin yerini belirsiz biçimde tuttuğu için belgisiz zamirdir.'),
 Q('tr8q4','“Senin için bu dosyayı hazırladım.” cümlesinde “için” hangi türdedir?',['Edat','Bağlaç','Zamir','Sıfat','Fiil'],0,'“İçin” bu kullanımda edattır.')
]),
T('k-tr-9-practice-01','k-tr','Cümlenin ögeleri','KPSS Cümlenin Ögeleri · Hızlı Pratik',[
 Q('tr9q1','“Öğretmen bugün sınıfta yeni konuyu anlattı.” cümlesinin öznesi hangisidir?',['bugün','sınıfta','yeni konuyu','öğretmen','anlattı'],3,'Anlatma işini yapan “öğretmen” öznesidir.'),
 Q('tr9q2','“Arkadaşım bana güzel bir kitap verdi.” cümlesinde dolaylı tümleç hangisidir?',['Arkadaşım','bana','güzel','bir kitap','verdi'],1,'Yönelme eki alan “bana” dolaylı tümleçtir.'),
 Q('tr9q3','“Sporcular sabah erkenden stadyuma gittiler.” cümlesinde zarf tümleci hangisidir?',['Sporcular','sabah erkenden','stadyuma','gittiler','stadyum'],1,'Zamanı belirten “sabah erkenden” zarf tümlecidir.'),
 Q('tr9q4','“Kardeşim odasını dün temizledi.” cümlesinde belirtili nesne hangisidir?',['Kardeşim','odasını','dün','temizledi','oda'],1,'“-ı” belirtme hâl eki almış “odasını” nesnedir.')
]),
T('k-tr-10-practice-01','k-tr','Cümle türleri','KPSS Cümle Türleri · Hızlı Pratik',[
 Q('tr10q1','“Hava karardığında eve döndük.” cümlesi yapısına göre hangisidir?',['Basit','Birleşik','Sıralı','Bağlı','Eksiltili'],1,'Zarf-fiil yan cümleciği bulunduğu için birleşik cümledir.'),
 Q('tr10q2','“Kapıyı açtı, içeri girdi.” cümlesi hangisidir?',['Basit','Birleşik','Sıralı','Bağlı','Devrik'],2,'Birden fazla yargı virgülle sıralandığı için sıralı cümledir.'),
 Q('tr10q3','“Kitabı okudum ama not almadım.” cümlesi yapısına göre hangisidir?',['Basit','Sıralı','Bağlı','Birleşik','Eksiltili'],2,'İki yargı “ama” bağlacıyla bağlandığı için bağlı cümledir.'),
 Q('tr10q4','“Bu sabah erkenden yola çıktık.” cümlesi yüklemin yerine göre hangisidir?',['Devrik','Kurallı','Eksiltili','Soru','Olumsuz'],1,'Yüklem sonda olduğu için kurallı cümledir.')
]),
