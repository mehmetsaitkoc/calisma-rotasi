...
assert.equal(defs.length,24,'Current original mini seed catalog must stay intact');
...
console.log('Mini catalog passed: original-only series + 4-set expansion scaffold');
