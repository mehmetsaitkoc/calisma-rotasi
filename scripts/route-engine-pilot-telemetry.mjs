...
assert.equal(d7.modes.bounces,0);
assert.equal(d7.modes.steadyDays,4);
assert.equal(d7.modes.repairDays,1);
assert.equal(d7.modes.sustainableDays,0);
assert.equal(d7.modes.progressDays,0);
