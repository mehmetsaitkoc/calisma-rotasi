...
const server=http.createServer(async (req,res)=>{
  ...
  if(req.method==='GET'&&req.url==='/api/public-config'){ return json(res,200,{supabase:{enabled:!!(SUPABASE_URL&&SUPABASE_PUBLISHABLE_KEY),url:SUPABASE_URL,publishableKey:SUPABASE_PUBLISHABLE_KEY}}); }
